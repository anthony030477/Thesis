...
class LLaMa:
    def __init__(self, model_dir):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(model_dir, use_fast=True, lstrip=False, token='access_token')
        ...
        self.model=AutoModelForCausalLM.from_pretrained(model_dir, token='access_token', device_map='cpu', torch_dtype=torch.float16)
